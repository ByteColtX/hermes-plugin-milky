...
- Place a case-sensitive, unescaped `[SPLIT]` alone on its own line or inline between text sections to split the reply into up to 3 sequential messages; the marker is stripped on outbound delivery.
